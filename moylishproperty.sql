...
CREATE Database IF NOT EXISTS moylishproperty;
use moylishproperty;


CREATE USER 'testuser'@'localhost' IDENTIFIED BY 'pass';GRANT ALL PRIVILEGES ON *.* TO ''@'localhost' IDENTIFIED BY 'pass' WITH GRANT OPTION MAX_QUERIES_PER_HOUR 0 MAX_CONNECTIONS_PER_HOUR 0 MAX_UPDATES_PER_HOUR 0 MAX_USER_CONNECTIONS 0; 
...
CREATE TABLE `styles` (
  ...
  `propertyStyle` varchar(20) DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
INSERT INTO `styles` (`styleId`, `propertyStyle`) VALUES
(1, 'Bungalow'),
(2, 'Semi Detached'),
(3, 'Detached '),
(4, 'Cottage'),
